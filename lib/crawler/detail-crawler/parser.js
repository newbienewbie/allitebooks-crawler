...
class Parser {
    ...
    parseEBookInfo(html){
        return new Promise(function(resolve,reject){
            ...
            const info={
                description,
                attachmentUrl:!!attachmentUrl?tryConvertUrlToAbsoluteUrl(attachmentUrl):"#",  // 如果在页面中未解析出附件地址，则将之置为“#”
            };
            ...
            rl.on('close',function(){
                ...
                // 出版年份
                let year=_meta.Year?parseInt(_meta.Year):'';
                year=isNaN(year)?"":year;
                // 页码数量
                let pages=_meta.pages?parseInt(_meta.Pages):'';
